    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-11 text-center">
                <h4 style="margin: 10px;">Providers</h4>
                        ...
                        <thead>
                            ...
                            @foreach($users as $user)
                                <tr>
                                    ...
                                    <td>{{ $user->phone}}</td>  
                                    <td>
                                       @if($user->email_verified_at != null || !is_null($user->email_verified_at) || !empty($user->email_verified_at))
                                            <a class="btn btn-sm btn-success disabled" ><i class="fa fa-check"></i></a>
                                        @else    
                                            <a href="{{ route ('admin.approve_provider',$user->id)}}"  class="btn btn-sm btn-info " ><i class="fa fa-check"></i></a>
                                        @endif
                                     <td>
