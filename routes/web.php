...
Route::get('/accommodation/{slug}/availability', [AccommodationBookingController::class, 'checkAvailability'])->name('accommodation.availability');
Route::post('/accommodation/{slug}/booking/review', [AccommodationBookingController::class, 'storeReview'])->name('accommodation.booking.storeReview');
Route::get('/accommodation/{slug}/booking/review', [AccommodationBookingController::class, 'showReview'])->name('accommodation.booking.review');
Route::post('/accommodation/booking/confirm', [AccommodationBookingController::class, 'confirm'])->middleware('auth')->name('accommodation.booking.confirm');
Route::get('/accommodation/booking/success/{reference}', [AccommodationBookingController::class, 'success'])->name('accommodation.booking.success');
...
Route::prefix('admin')->as('admin.')->middleware(['auth', 'CheckUserRole'])->group(function () {
    ...
    Route::get('/accommodation-bookings', [AdminAccommodationBookingController::class, 'index'])->name('accommodation_bookings.index');
    Route::get('/accommodation-bookings/{booking}', [AdminAccommodationBookingController::class, 'show'])->name('accommodation_bookings.show');
    Route::post('/accommodation-bookings/{booking}/status', [AdminAccommodationBookingController::class, 'updateStatus'])->name('accommodation_bookings.update_status');
