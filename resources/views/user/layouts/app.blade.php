...
<body>
    ...
    {{--
        ...
        <div id="user-page" class="w-100 bg-[#009900] text-white p-3 flex justify-center flex-col items-center gap-6">
            <div class="lg:max-w-[1110px] w-[90vw]  text-white flex justify-center flex-col items-center gap-2">
    ...
    <div class="tour-img">
        ...
        <div class="tour-text">
            <h2 class="lg:text-5xl text-4xl">My Account</h2>
         ...
         <div class="mx-auto w-[90vw]">
            <div class="md:grid md:grid-cols-12 gap-4">
                <div class="col-span-3 bg-white rounded-md shadow-lg py-16  md:px-4 px-2">
                    <ul>
                        <a class="no-underline " href="{{ route('user.dashboard') }}">
                            <li class=" @if (Request::routeIs('user.dashboard')) bg-[#008000] text-white @endif hover:bg-green-600 rounded-md  hover:text-white text-[#1a1a1a] text-lg p-2">
                                Profile
                            </li>
                        </a>
                        <a href="{{ route('user.my_bookings') }}">
                            <li class=" @if (Request::routeIs('user.my_bookings')) bg-[#008000] text-white @endif mt-2 hover:bg-green-600 rounded-md  hover:text-white text-[#1a1a1a] text-lg p-2">
                                    My Bookings
                            </li>
                        </a>
                        <a href="{{ route('user.change_password') }}"> 
                            <li class=" @if (Request::routeIs('user.change_password')) bg-[#008000] text-white @endif mt-2 hover:bg-green-600 rounded-md  hover:text-white text-[#1a1a1a] text-lg p-2">
                                Change Password
                            </li>
                        </a>
                        <a href="{{ route('logout') }}">
                            <li class=" @if (Request::routeIs('logout')) bg-[#008000]  text-white @endif mt-2 hover:bg-green-600 rounded-md  hover:text-white text-[#1a1a1a] text-lg p-2">
                                Logout
                            </li>
                        </a>
                    </ul>
    ...
    <div id="user-page" class="bg-gray-100">
        <div class="lg:max-w-[1110px] w-[90vw] mx-auto  pt-16 pb-8">
