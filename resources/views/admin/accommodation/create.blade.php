    ...
    <form action="{{ route('admin.accommodation.store') }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 space-y-5">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
            ...
            <div>
                ...
                <input type="number" name="bathrooms" value="{{ old('bathrooms', 1) }}" min="0" required class="w-full rounded-lg border border-gray-300 px-3 py-2 text-gray-900 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
            </div>
            <div>
